                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">Shopperia</h2>
                            <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #89777</h1>
                            <p className="leading-relaxed mb-4 text-green-600 ">Your order has placed sucessfully placed</p>
                            <div className="flex mb-4">
                                <a className="flex-grow border-gray-300 py-2 text-lg px-1 text-left">Item Description</a>
                            ...
                            <div className="flex flex-col">
                                <span className="title-font font-medium text-2xl text-gray-900">SubTotal: ₹5892.00</span>
                                <div className="my-5">
